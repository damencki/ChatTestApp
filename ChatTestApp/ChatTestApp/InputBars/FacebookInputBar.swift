...
class FacebookInputBar: InputBarAccessoryView {
    ...
    var onSelected: InputBarButtonItem.InputBarButtonItemAction?
    ...
    func configure() {
        ...
        button.onSelected { [weak self] item in
        ...
        button.setImage(UIImage.init(named: "paperClipSimpleLineIcons")?.withRenderingMode(.alwaysTemplate), for: .normal)
...
extension FacebookInputBar: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
